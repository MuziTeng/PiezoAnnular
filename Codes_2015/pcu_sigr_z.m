...
plot(zz,sigr2(:,1),'b-.','linewidth',3),hold on
plot(zz,sigr2(:,3),'g-','linewidth',3),hold on
plot(zz,sigr2(:,5),'k--','linewidth',3),hold on
...
print -depsc -r300 C:\Users\ST\Desktop\»»ª∑∞Â\cu_sigr_z.eps
